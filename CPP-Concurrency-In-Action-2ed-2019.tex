...
\definecolor{mygreen}{RGB}{240, 248, 255}
\pagecolor{mygreen}
...
\begin{document}
	\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
		...
		\mySection{附录A}{对C++11 特性的简要介绍}{content/appendix_A/0.tex}
		...
		\mySubsection{D.1.}{<chrono>头文件}{content/appendix_D/1.tex}
		\mySubsection{D.2.}{<condition\_variable>头文件}{content/appendix_D/2.tex}
		\mySubsection{D.3.}{<atomic>头文件}{content/appendix_D/3.tex}
		\mySubsection{D.4.}{<future>头文件}{content/appendix_D/4.tex}
		\mySubsection{D.5.}{<mutex>头文件}{content/appendix_D/5.tex}
		\mySubsection{D.6.}{<ratio>头文件}{content/appendix_D/6.tex}
		\mySubsection{D.7.}{<thread>头文件}{content/appendix_D/7.tex}
		\newpage
	\end{sloppypar}
\end{document}
